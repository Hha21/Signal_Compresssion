...
def create_network (params):
    ...
    if activation == 'linear':
        ...
        z, x_decode, encoder_weights, encoder_biases, decoder_weights, decoder_biases = non_linear_autoencoder(x, input_dim, latent_dim, params['widths'], activation=activation)
...
def non_linear_autoencoder(x, input_dim, latent_dim, widths, activation = 'elu'):
    ...
    z, encoder_weights, encoder_biases = build_network_layers(x, input_dim, latent_dim, widths, activation_function, 'autoencoder')
